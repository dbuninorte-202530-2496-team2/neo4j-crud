...
export default function PostModal({ post, comentarios, onClose, usuarioActual, onAgregarComentario }) {
  if (!post) return null;
  ...
  const handleAgregarComentario = (contenido) => {
    const comentario = {
      consec: Date.now(),
      ...
      >
        ...
        >
          ...
          <div className="mb-4">
            ...
            <ComentariosList comentarios={comentariosDelPost} />
          </div>
